#include "LIARootListController.h"
#import "../Tweak/Lobelias.h"
...
@implementation LIARootListController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/LobeliasPrefs.bundle/icon@2x.png"];
...
- (void)viewDidLoad {
    ...
    self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/LobeliasPrefs.bundle/Banner.png"];
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/Library/MobileSubstrate/DynamicLibraries/Lobelias.disabled"]) return;
...
- (void)resetPrompt {
    ...
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Lobelias"
